...
class TileGridModelTest(unittest.TestCase):
	...
	def test_get_tiles_in_rect_returns_all_tiles_within_a_bounding_rectangle(self):
		...
		self.assertIn("(3.0,4.0)", [ t.tile_id for t in tiles_in_rect ])
		self.assertIn("(3.0,6.0)", [ t.tile_id for t in tiles_in_rect ])
		self.assertIn("(4.0,4.0)", [ t.tile_id for t in tiles_in_rect ])
		self.assertIn("(4.0,6.0)", [ t.tile_id for t in tiles_in_rect ])
