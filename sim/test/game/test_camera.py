...
class CameraTest(unittest.TestCase):
	...
	def test_convert_world_point_to_view_point_transforms_a_point_in_world_space_to_a_point_in_view_space(self):  # noqa
		tmap = TileMap(TileGrid(Size(12, 16)), tile_sz=Size(10, 10))
		cam = Camera(tmap)
		cam.view_rect = Rectangle(Point(2, 3), Size(2, 3))
		self.assertEqual(
			cam.convert_world_point_to_view_point(Point(3, 4)),
			Point(3/120*2+2, 4/160*3+3),
			)
	...
	def test_ortho_matrix_returns_a_cameras_view_rect_as_an_ortho_matrix_friendlly_for_opengl(self):  # noqa
