import unittest
import numpy
from sim.geometry import Pair, Point, Vector, Size, Rectangle
from sim.geometry import GeometryException
...
class GeometryTest(unittest.TestCase):
	...
	def test_pair_eq_returns_true_if_two_pairs_have_the_same_values_in_order(self):  # noqa
		p1 = Pair(2, 3)
		p2 = Pair(2, 3)
	...
	def test_pair_add_returns_a_translated_pair_that_is_the_sum_of_the_original_and_a_scalar(self):  # noqa
		p1 = Pair(2, 3)
		self.assertEqual(p1 + 5, Pair(7, 8))

	def test_pair_sub_returns_a_new_pair_that_is_the_difference_of_two_others(self):  # noqa
		p1 = Pair(2, 3)
		p2 = Pair(7, 9)
		self.assertEqual(p1 - p2, Pair(-5, -6))

	def test_pair_mul_returns_a_scaled_pair_that_is_the_product_of_the_original_and_a_scalar(self):  # noqa
		p1 = Pair(2, 3)
		self.assertEqual(p1 * 5, Pair(10, 15))

	def test_pair_mul_returns_a_new_pair_that_is_the_product_of_two_others(self):  # noqa
		p1 = Pair(2, 3)
		p2 = Pair(7, 9)
		self.assertEqual(p1 * p2, Pair(14, 27))

	def test_pair_truediv_returns_a_new_pair_that_is_the_quotient_of_two_others(self):  # noqa
		p1 = Pair(2, 3)
		p2 = Pair(7, 9)
		self.assertEqual(p1 / p2, Pair(2/7, 3/9))

	def test_pair_neg_returns_a_new_pair_that_is_the_quotient_of_two_others(self):  # noqa
		p1 = Pair(2, 3)
	...
	def test_point_sub_returns_a_vector_difference_between_the_two_points(self):  # noqa
		p1 = Point(2, 3)
		p2 = Point(7, 9)
		p3 = p1 - p2
	...
	def test_rectangle_repr_returns_a_string_representation_of_the_rectangle(self):  # noqa
		p = Point(2, 3)
		sz = Size(3, 4)
		self.assertTrue(str(Rectangle(p, sz)), "[(2.00,3.00) /3.00,4.00/]")

	def test_rectangle_contains_returns_true_if_a_point_is_in_or_on_a_rectangles_boundary(self):  # noqa
	...
	def test_scale_y_returns_a_rectangle_with_its_height_multiplied_by_a_scale_factor_centered_on_the_same_center_as_the_source_rectangle(self):  # noqa
		r = Rectangle(Point(2, 3), Size(3, 4))
		self.assertEqual(
			r.scale_y(3),
			Rectangle(Point(2, 3-(12-4)/2), Size(3, 12)),
			)

	def test_scale_y_with_center_set_to_false_returns_a_rectangle_with_its_height_multiplied_by_a_scale_factor_anchored_to_the_same_point_as_the_source_rectangle(self):  # noqa
		r = Rectangle(Point(2, 3), Size(3, 4))
		self.assertEqual(
			r.scale_y(3, center=False),
			Rectangle(Point(2, 3), Size(3, 12)),
			)
	...
	def test_translate_x_returns_a_rectangle_that_has_been_translated_by_distance_in_x(self):  # noqa
		r = Rectangle(Point(2, 3), Size(3, 4))
	...
	def test_ll_lr_ur_ul_properties_return_the_corner_points_of_the_rectangle(self):  # noqa
		r = Rectangle(Point(2, 3), Size(3, 4))
